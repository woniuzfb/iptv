...
## 自动更新指定的json文件
    ...
    "sync_pairs":"chnl_name:channel_name,chnl_id:output_dir_name,chnl_pid:pid,chnl_cat=港澳台,url:http://xxx.com/live", # 值配对用:号，如果直接赋值用=号（除了公开的live根目录，会自动补上完整的m3u8地址）
